...
void treereader::setloopkeys_minos(){
    // Set Branches we want to read
    currenteventnum = 0; // reset event number on change of readout
    if(!fChain) __throw_exception_again;
    
    fChain->SetBranchStatus("*",false);
    const std::array<std::string, 26> Vals{
            "BigRIPSBeam.aoq", "BigRIPSBeam.zet", "F3X", "F3A",
            "F5X", "F5A", "F9X", "F9A", "F11X", "F11A",
            "BigRIPSPPAC.fX", "BigRIPSPPAC.fY", "BigRIPSRIPS.brho",
            "EventInfo.fUniqueID", "VDrift", "MinosClustX", "MinosClustY",
...
void treereader::setloopkeys_cs(){
    // Set Branches we want to read
    currenteventnum = 0; // reset event number on change of readout
    if(!fChain) __throw_exception_again;
    
    fChain->SetBranchStatus("*",false);
    const std::array<std::string, 14> Vals{
            "BigRIPSBeam.aoq", "BigRIPSBeam.zet", "F3X", "F3A",
            "F5X", "F5A", "F9X", "F9A", "F11X", "F11A",
            "BigRIPSPPAC.fX", "BigRIPSPPAC.fY", "BigRIPSRIPS.brho",
            "EventInfo.fUniqueID"
...
void treereader::Init(TTree *tree){
    ...
    if(!PID_only) {
        ...
        fChain->SetBranchAddress("BigRIPSPlastic.fQTCLRawWidth", BigRIPSPlastic_fQTCLRawWidth,
                                 &b_BigRIPSPlastic_fQTCLRawWidth);
        fChain->SetBranchAddress("BigRIPSPlastic.fQTCRRawWidth", BigRIPSPlastic_fQTCRRawWidth,
                                 &b_BigRIPSPlastic_fQTCRRawWidth);
        fChain->SetBranchAddress("BigRIPSPlastic.fQTCLRawStart", BigRIPSPlastic_fQTCLRawStart,
                                 &b_BigRIPSPlastic_fQTCLRawStart);
        fChain->SetBranchAddress("BigRIPSPlastic.fQTCRRawStart", BigRIPSPlastic_fQTCRRawStart,
                                 &b_BigRIPSPlastic_fQTCRRawStart);
        fChain->SetBranchAddress("BigRIPSPlastic.fTLRawArray", BigRIPSPlastic_fTLRawArray,
                                 &b_BigRIPSPlastic_fTLRawArray);
        fChain->SetBranchAddress("BigRIPSPlastic.fTRRawArray", BigRIPSPlastic_fTRRawArray,
                                 &b_BigRIPSPlastic_fTRRawArray);
        ...
        fChain->SetBranchAddress("BigRIPSFocalPlane.fUniqueID", BigRIPSFocalPlane_fUniqueID,
                                 &b_BigRIPSFocalPlane_fUniqueID);
        ...
        fChain->SetBranchAddress("BigRIPSFocalPlane.fDataState", BigRIPSFocalPlane_fDataState,
                                 &b_BigRIPSFocalPlane_fDataState);
        fChain->SetBranchAddress("BigRIPSFocalPlane.opt_vector", BigRIPSFocalPlane_opt_vector,
                                 &b_BigRIPSFocalPlane_opt_vector);
        ...
        fChain->SetBranchAddress("BigRIPSFocalPlane.nfired_ppacx", BigRIPSFocalPlane_nfired_ppacx,
                                 &b_BigRIPSFocalPlane_nfired_ppacx);
        fChain->SetBranchAddress("BigRIPSFocalPlane.nfired_ppacy", BigRIPSFocalPlane_nfired_ppacy,
                                 &b_BigRIPSFocalPlane_nfired_ppacy);
        fChain->SetBranchAddress("BigRIPSFocalPlane.zpos", BigRIPSFocalPlane_zpos, &b_BigRIPSFocalPlane_zpos);
        fChain->SetBranchAddress("BigRIPSFocalPlane.zpos_offset", BigRIPSFocalPlane_zpos_offset,
                                 &b_BigRIPSFocalPlane_zpos_offset);
        ...
        fChain->SetBranchAddress("BigRIPSRIPS.downstream_fpl", BigRIPSRIPS_downstream_fpl,
                                 &b_BigRIPSRIPS_downstream_fpl);
        ...
        fChain->SetBranchAddress("BigRIPSTOF.upstream_plname", BigRIPSTOF_upstream_plname,
                                 &b_BigRIPSTOF_upstream_plname);
        fChain->SetBranchAddress("BigRIPSTOF.downstream_plname", BigRIPSTOF_downstream_plname,
                                 &b_BigRIPSTOF_downstream_plname);
        fChain->SetBranchAddress("BigRIPSTOF.upstream_plfpl", BigRIPSTOF_upstream_plfpl, &b_BigRIPSTOF_upstream_plfpl);
        fChain->SetBranchAddress("BigRIPSTOF.downstream_plfpl", BigRIPSTOF_downstream_plfpl,
                                 &b_BigRIPSTOF_downstream_plfpl);
